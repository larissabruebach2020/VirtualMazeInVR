...
public static class ConditionModel
{
    ...
    public static void Init(int id, string audioAgent_A, string animationAgent_A, Vector3 positionAgent_A, string audioAgent_B, string animationAgent_B, Vector3 positionAgent_B)
    {
